...
export default function Process() {
    return (
        <section id="process" className="scroll-mt-24 py-24 px-6 bg-[#0A0F1A] relative">
            ...
            <div className="container mx-auto max-w-5xl">
                ...
                >
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold font-[family-name:var(--font-syne)] text-[#E5E7EB] mb-4">My Process</h2>
                                ...
                                >
                                    ...
                                    <div className="relative z-10 mx-auto w-[88px]">
                                        <motion.div
                                            ...
                                            className="w-[22px] h-[22px] mx-auto rounded-full bg-[#0A0F1A] border-2 border-[#38BDF8]/30 group-hover:border-[#38BDF8] group-hover:shadow-[0_0_15px_rgba(56,189,248,0.3)] transition-all flex items-center justify-center"
                                        >
                                    ...
                                    <div className="mt-8 space-y-3">
                                        ...
                                        <h3 className="text-base font-bold text-[#E5E7EB] group-hover:text-[#38BDF8] transition-colors font-[family-name:var(--font-syne)]">
                                            {step.title}
                                        </h3>
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="pt-1">
                                    ...
                                    <h3 className="text-lg font-bold text-[#E5E7EB] font-[family-name:var(--font-syne)]">{step.title}</h3>
                                    <p className="text-sm text-[#8B95A9] leading-relaxed mt-1">{step.description}</p>
                                </div>
                            </motion.div>
                        );
                    })}
